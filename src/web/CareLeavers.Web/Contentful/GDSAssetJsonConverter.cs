...
namespace CareLeavers.Web.Contentful
{
    ...
    public class GDSAssetJsonConverter : JsonConverter
    {
        ...
        public override object? ReadJson(JsonReader reader, Type objectType, object? existingValue, JsonSerializer serializer)
        {
            ...
            {
                return serializer.ReferenceResolver!.ResolveReference(serializer, ((JValue) refId).Value?.ToString() ?? string.Empty);
            }
            ...
            if (serializer.ReferenceResolver?.ResolveReference(serializer, asset.SystemProperties?.Id ?? string.Empty) is Asset existing)
            {
                return existing;
            }
